---
description: Task-loop implementation with backend tests per task, for Odoo 17, 18, 19, or 20. Requires a PRD (docs/tasks.md) — auto-routes to /plan-analysis if missing.
...
19, or 20), working through `docs/tasks.md` task-by-task with a backend test after
