---
description: Frontend UI tests plus responsive documentation (index.html, screenshots) for Odoo 17, 18, 19, or 20. Requires all tasks complete — auto-routes to /start-coding if not.
...
exactly one of 17, 18, 19, or 20), using the `agent_browser_automation` and
