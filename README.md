...
| DeepSeek Harness agent preset — lifecycle commands, all 22 skills, in-process `odoo_*` discovery tools, and per-version Odoo documentation retrieval from the OKF knowledge bundles | `integrations/deepseek/` |
